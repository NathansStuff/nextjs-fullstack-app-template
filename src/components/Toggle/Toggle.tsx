 ...
 * @version 1
 */
export function Toggle({ initiallyChecked = false, onChange }: IToggle): JSX.Element {
  ...
  return (
    <Switch
      ...
      className={`${checked ? activeClass : inactiveClass} relative inline-flex h-6 w-11 items-center rounded-full`}
    >
